...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'vennela24'
    assert response.json()['email'] == 'vennela@email.com'
    assert response.json()['first_name'] == 'vennela'
    assert response.json()['last_name'] == 'gowda'
